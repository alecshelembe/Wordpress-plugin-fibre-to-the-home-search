...
function pointInPolygon($point, $polygon) {
    ...
    function searchKMLfileforgivenpoint( $point ) {
        ...
        $kmlFilePath  = 'kml_files/MFN_Live_Coverage.kml';  // Replace with the path to your KML file
    ...
    // $response_data = findPolygons("kml_files/MFN_Live_Coverage.kml");

    // $response_data = isPointInsidePolygons($latitude, $longitude,$response_data);
